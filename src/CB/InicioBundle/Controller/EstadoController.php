...
use CB\InicioBundle\Form\EstadoType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('InicioBundle:Estado')->findAll();
     ...
     * @Method("POST")
     * @Template("InicioBundle:Estado:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InicioBundle:Estado')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("InicioBundle:Estado:edit.html.twig")
     */
