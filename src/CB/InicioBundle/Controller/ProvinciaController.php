...
use CB\InicioBundle\Form\ProvinciaType;
...
class ProvinciaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('InicioBundle:Provincia')->findAll();
     ...
     * @Method("POST")
     * @Template("InicioBundle:Provincia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('InicioBundle:Provincia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("InicioBundle:Provincia:edit.html.twig")
     */
